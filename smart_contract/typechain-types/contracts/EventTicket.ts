...
export interface EventTicketInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "decreaseBasePrice",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "dynamicPricing",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "ownsToken", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "priceIncrement",
    data: BytesLike
  ): Result;
...
export interface EventTicket extends BaseContract {
  ...
  decreaseBasePrice: TypedContractMethod<[], [void], "nonpayable">;

  dynamicPricing: TypedContractMethod<[], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "decreaseBasePrice"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "dynamicPricing"
